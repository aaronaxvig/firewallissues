...
```caveat
WF-500-B appliances only
```

Fixed an issue where the WildFire appliance failed to fetch device certificates due to a syntax error in the system database format.
