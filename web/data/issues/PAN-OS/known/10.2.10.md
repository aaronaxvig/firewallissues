...
```caveat
(PAN-OS 10.2.10-h2 through PAN-OS 10.2.10-h12) This issue is now resolved. See PAN-OS 10.2.10-h14 Addressed Issues.
```
...
```caveat
PA-5250 firewall only
```

Applying filters under **Monitor** > **Log Display** either causes the logs to load slowly or not load at all.

## PAN-268815

```caveat
(PAN-OS 10.2.10-h9 only) This issue is now resolved. See PAN-OS 10.2.13-h5 Addressed Issues.
```
...
```caveat
(PAN-OS 10.2.10-h2 and 10.2.10-h3 only)
```
...
```caveat
(PAN-OS 10.2.10-h9 only)This issue is now resolved. See PAN-OS 10.2.13 Addressed Issues.
```
