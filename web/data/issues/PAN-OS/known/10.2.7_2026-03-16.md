...
The web interface is unresponsive after upgrading to PAN-OS 10.2.7-h18. The following error is generated: `PHP Fatal error: require(): Failed opening required`
...
```caveat
PA-3400 and PA-5400 Series firewalls
```
