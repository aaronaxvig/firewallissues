...
```caveat
This issue is now resolved. See PAN-OS 9.0.10 Addressed Issues
```

Selecting **Preview Changes** under a specific device group results in the following error message: `Parameter device group missing`.
