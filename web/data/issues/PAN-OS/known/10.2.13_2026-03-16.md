...
A race condition issue leads to a dataplane restart when a predict session is hit at the moment when it's timing out.

## PAN-288930

```caveat
(PAN-OS 10.2.13-h7 only) This issue is now resolved. See PAN-OS 10.2.15 Addressed Issues
```
...
```caveat
This issue affects PAN-OS 10.2.13-h5 This issue is now resolved. See PAN-OS 10.2.13-h7 Addressed Issues.
```
...
```caveat
(PAN-OS 10.2.13-h1 through PAN-OS 10.2.13-h4) This issue is now resolved. See PAN-OS 10.2.13-h5 Addressed Issues.
```
...
```caveat
(PAN-OS 10.2.13-h3 only) This issue is now resolved. See PAN-OS 10.2.13-h4 Addressed Issues.
```
...
```caveat
(PAN-OS 10.2.13-h4 only) This issue is now resolved. See PAN-OS 10.2.14 Addressed Issues
```
...
```caveat
(PAN-OS 10.2.13-h4 and later 10.2.13 releases) This issue is now resolved. See PAN-OS 10.2.14 Addressed Issues
```
...
```caveat
(PAN-OS 10.2.13-h4 only) This issue is now resolved. See PAN-OS 10.2.13-h5 Addressed Issues.
```
